...
export const SECTION_TYPE_TO_POINTS = {
  [INTERNAL_SECTION_TYPES.WORK_EXPERIENCE]: 25,
  [INTERNAL_SECTION_TYPES.EDUCATION]: 15,
  [INTERNAL_SECTION_TYPES.SUMMARY]: 15,
} as const;

export const FIELDS_TO_POINTS = {
  [FIELD_NAMES.PERSONAL_DETAILS.EMAIL]: 5,
  [FIELD_NAMES.PERSONAL_DETAILS.WANTED_JOB_TITLE]: 10,
  [FIELD_NAMES.LANGUAGES.LANGUAGE]: 3,
  [FIELD_NAMES.SKILLS.SKILL]: 3,
} as const;
