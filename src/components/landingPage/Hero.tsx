  ...
  return (
    <section className='md:py-32 container px-4 py-24 mx-auto'>
      <div className='max-w-4xl mx-auto space-y-8 text-center'>
        ...
        <h1 className='bg-linear-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-4xl font-bold tracking-tight text-transparent sm:text-5xl md:text-6xl lg:text-7xl py-1'>
