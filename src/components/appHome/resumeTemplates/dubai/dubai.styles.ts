...
export const DUBAI_ACCENT_COLOR = '#c8a96e';
...
export const dubaiTemplateStyles = StyleSheet.create({
  page: {
    fontFamily: 'Roboto',
    flexDirection: 'row',
  ...
  sidebarSectionLabel: {
    ...
    marginBottom: 8,
    paddingBottom: 4,
    borderBottom: `1px solid ${DUBAI_ACCENT_COLOR}`,
  },
  sidebarText: {
  ...
  mainSectionLabel: {
    ...
    marginBottom: 8,
    paddingBottom: 4,
    borderBottom: `1.5px solid ${DUBAI_ACCENT_COLOR}`,
  },
  entryWrapper: {
    marginBottom: 10,
  },
  ...
  bullet: {
    ...
    marginRight: 6,
    marginTop: 4,
    backgroundColor: DUBAI_ACCENT_COLOR,
  },
});
