...
export const TOKYO_ACCENT_LINE = '#4f8ef7';
...
export const tokyoTemplateStyles = StyleSheet.create({
  page: {
    fontFamily: 'Roboto',
    flexDirection: 'row',
  ...
  sidebarSectionLabel: {
    ...
    letterSpacing: 1.2,
    marginBottom: 8,
    borderBottom: `1px solid ${TOKYO_ACCENT_LINE}`,
    paddingBottom: 4,
  },
  sidebarText: {
  ...
  mainSectionLabel: {
    ...
    marginBottom: 2,
    paddingBottom: 4,
    borderBottom: `2px solid ${TOKYO_ACCENT_LINE}`,
  },
  mainText: {
    fontSize: TOKYO_FONT_SIZE,
    color: '#2d2d2d',
  ...
  bullet: {
    ...
    marginRight: 6,
    marginTop: 4,
    backgroundColor: TOKYO_ACCENT_LINE,
  },
  // Skill bar
  skillRow: {
    flexDirection: 'row',
