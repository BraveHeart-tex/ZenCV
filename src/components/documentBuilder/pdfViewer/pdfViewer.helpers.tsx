...
export const getPdfTemplateByType = (pdfTemplateData: PdfTemplateData) => {
  ...
  if (pdfTemplateData.templateType === INTERNAL_TEMPLATE_TYPES.LONDON) {
    return <LondonTemplate templateData={pdfTemplateData} />;
  }

  if (pdfTemplateData.templateType === INTERNAL_TEMPLATE_TYPES.TOKYO) {
    return <TokyoTemplate templateData={pdfTemplateData} />;
  }

  if (pdfTemplateData.templateType === INTERNAL_TEMPLATE_TYPES.DUBAI) {
    return <DubaiTemplate templateData={pdfTemplateData} />;
  }

  if (pdfTemplateData.templateType === INTERNAL_TEMPLATE_TYPES.SYDNEY) {
